-- Script para executar schema nos bancos de desenvolvimento e teste
-- Execute via PowerShell com: .\setup-databases.ps1

-- Este arquivo contém o schema completo para ambos os bancos

-- BPS Brasil - Schema SQL
-- Compatível com PostgreSQL (pgAdmin 4)
...
-- Inserir usuário funcionário de teste (senha: func123)
-- Hash gerado com bcrypt rounds 10
INSERT INTO
    funcionarios (
        cpf,
...
VALUES (
        ...
        'Desenvolvedor',
        'joao@bps.com.br',
        '$2a$10$F3QK5YrKGQJN5yXZ9K5yXOK5YrKGQJN5yXZ9K5yXOK5YrKGQJN5yF',
        'funcionario'
    ) ON CONFLICT (cpf) DO NOTHING;
...
SELECT cpf, nome, email, perfil, ativo
FROM funcionarios
